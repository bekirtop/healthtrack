        ...
        <Box sx={{ display: 'flex', gap: 1 }}>
          {role === 'Admin' && (
            <>
              ...
              <NavButton path="/admin/doctor-patients" label="Atamalar" icon={LinkIcon} />
            </>
          )}
          ...
          {role === 'Doctor' && (
            <>
              ...
              <NavButton path="/doctor/social" label="Sosyal Akış" icon={DynamicFeedIcon} />
              <NavButton path="/doctor/educational" label="Eğitim Materyalleri" icon={LibraryBooksIcon} />
            </>
          )}
        </Box>
